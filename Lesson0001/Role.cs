...
namespace Lesson0001
{
    ...
    class Role
    {
        ...
        {
            Console.WriteLine("怪物的名字是{0},当前的生命值是{1},攻击力是{2},防御力是{3}", name, currentLive, attack, defined);
        }
    }
}
